...
class VigilantAssigment:
    ...
    def generateResults(self,path,solution):
        self.generateResultBySite(path,solution)
        self.generateResultByVigilant(path,solution)

    def generateResultBySite(self,path,solution):
        ...
        for sideId in range(0,len(solution.sitesSchedule)):
            ...
            if len(solution.sitesSchedule[sideId]) > 0:
                ...
                for assignedVigilantsInPeriod in range(0,len(siteSchedule)):
                    ...
                    cantMissingVigilants+= self.cantVigilantsPeriod[sideId][assignedVigilantsInPeriod] - len(siteSchedule[assignedVigilantsInPeriod]) 
                    period+=1
                    if period == 24:
        ...
        writer.close()
    def generateResultByVigilant(self,path,solution):
